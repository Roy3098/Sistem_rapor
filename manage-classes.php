...
<head>
    ...
    <title>Kelola Kelas & Siswa - Baiturrahman Web</title>
...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    <div class="container mx-auto px-4 py-6 max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-lg mb-4 fade-in">
            <div class="flex items-center justify-between p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-lg font-bold text-gray-800">Kelola Kelas & Siswa</h1>
                        <p class="text-xs text-gray-600">Manajemen data kelas dan siswa</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-20">
            ...
            <div class="grid grid-cols-2 gap-3 mb-6">
                <button onclick="showAddClassModal()" class="bg-gradient-to-r from-orange-500 to-red-500 text-white py-3 px-4 rounded-xl font-semibold hover:from-orange-600 hover:to-red-600 transition-all text-sm">
                    ➕ Tambah Kelas
                </button>
                <button onclick="showAddStudentModal()" class="bg-gradient-to-r from-green-500 to-emerald-500 text-white py-3 px-4 rounded-xl font-semibold hover:from-green-600 hover:to-emerald-600 transition-all text-sm">
                    👤 Tambah Siswa
                </button>
            </div>
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                ...
                                <div class="text-sm text-gray-600 mt-1">
                                    ...
                                    <div>Wali: <?php echo htmlspecialchars($student['guardian'] ?: 'Belum diisi'); ?></div>
                                </div>
                            </div>
                            <div class="flex space-x-2 ml-4">
            ...
            <form method="POST">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="name" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all" placeholder="Contoh: X IPA 1">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Wali Kelas</label>
                        <input type="text" name="teacher" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all" placeholder="Nama wali kelas">
                    </div>
                </div>
                <div class="flex space-x-3 mt-6">
                    ...
                    <button type="button" onclick="hideAddClassModal()" class="flex-1 bg-gray-100 text-gray-700 py-3 rounded-xl font-semibold hover:bg-gray-200 transition-all">
                        Batal
                    </button>
                </div>
            </form>
    ...
    <div id="addStudentModal" class="modal">
        <div class="modal-content">
            <h2 class="text-xl font-bold text-gray-800 mb-4">Tambah Siswa Baru</h2>
            <form method="POST">
                <input type="hidden" name="action" value="add_student">
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">No Induk Siswa (NIS)</label>
                        <input type="text" name="student_id" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all" placeholder="NIS siswa">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Nama Lengkap *</label>
                        <input type="text" name="name" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all" placeholder="Nama lengkap siswa">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="birth_place" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all" placeholder="Tempat lahir">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="guardian" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all" placeholder="Nama wali atau orang tua">
                    </div>
                </div>
                <div class="flex space-x-3 mt-6">
                    ...
                    <button type="button" onclick="hideAddStudentModal()" class="flex-1 bg-gray-100 text-gray-700 py-3 rounded-xl font-semibold hover:bg-gray-200 transition-all">
                        Batal
                    </button>
                </div>
            </form>
    ...
    <div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-40">
        <div class="container mx-auto px-4 max-w-md">
            <div class="flex justify-around py-2">
                ...
                <a href="manage-classes.php" class="flex flex-col items-center py-2 px-3 text-blue-600 bg-blue-50 rounded-lg transition-all">
                    <svg class="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
